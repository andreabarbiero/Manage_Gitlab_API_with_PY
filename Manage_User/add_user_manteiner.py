...
user_list = ["topolino.disney","paperino.disney","pluto.disney"]  # Aggiorna con la tua lista di nomi utente
...
for username in user_list:
    ...
    user_data = {
        "username": username,
        "password": "PASSWORD_INIZIALE_UTENTE",  # Aggiorna con la password desiderata
        "email": f"{username}@TUO_DOMINIO.it",  # Aggiorna con l'email desiderata
        "name": username,  # Aggiungi il campo "name" con il valore dello username
        "skip_confirmation": True,  # Imposta il flag "skip_confirmation" su True
    }
